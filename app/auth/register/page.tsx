          ...
          <form className="space-y-6 mt-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              ...
              <div className="group animate-slide-in-up">
                ...
                <div className="relative">
                  <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'withdrawalAccount' ? 'text-red-600' : 'text-gray-400'}`}><CreditCard className="h-5 w-5" /></div>
                  <input id="withdrawalAccount" name="withdrawalAccount" type="text" value={formData.withdrawalAccount} onChange={handleChange} onFocus={() => setFocusedField('withdrawalAccount')} onBlur={() => setFocusedField(null)} className="block w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/20 transition-all duration-300 hover:border-gray-300" placeholder="Enter your Minipay account" />
                </div>
              </div>
            </div>
