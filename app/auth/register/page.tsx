        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 animate-fade-in-up">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-5">
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'username' ? 'text-indigo-600' : 'text-gray-400'}`}><User className="h-5 w-5" /></div>
                    <input id="username" name="username" type="text" autoComplete="username" required value={formData.username} onChange={handleChange} onFocus={() => setFocusedField('username')} onBlur={() => setFocusedField(null)} className="block w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-300 hover:border-gray-300" placeholder="Choose a username" />
                  </div>
                </div>
                {/* Email */}
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'email' ? 'text-indigo-600' : 'text-gray-400'}`}><Mail className="h-5 w-5" /></div>
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'password' ? 'text-indigo-600' : 'text-gray-400'}`}><Lock className="h-5 w-5" /></div>
                    ...
                    <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center hover:text-indigo-600 transition-colors duration-300" onClick={() => setShowPassword(!showPassword)}>{showPassword ? <EyeOff className="h-5 w-5 text-gray-400" /> : <Eye className="h-5 w-5 text-gray-400" />}</button>
                  </div>
                </div>
                {/* Confirm Password */}
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'confirmPassword' ? 'text-indigo-600' : 'text-gray-400'}`}><Lock className="h-5 w-5" /></div>
                    ...
                    <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center hover:text-indigo-600 transition-colors duration-300" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>{showConfirmPassword ? <EyeOff className="h-5 w-5 text-gray-400" /> : <Eye className="h-5 w-5 text-gray-400" />}</button>
                  </div>
                </div>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="space-y-5">
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'name' ? 'text-indigo-600' : 'text-gray-400'}`}><User className="h-5 w-5" /></div>
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <div className="relative">
                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${focusedField === 'location' ? 'text-indigo-600' : 'text-gray-400'}`}><MapPin className="h-5 w-5" /></div>
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <div className="flex items-center gap-4">
                    {formData.profileImage && <img src={formData.profileImage} alt="Profile Preview" className="w-16 h-16 rounded-full object-cover border-2 border-indigo-200" />}
                    <input ref={fileInputRef} type="file" accept="image/*" className="hidden" onChange={handleImageChange} />
                    <button type="button" className="px-4 py-2 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 flex items-center gap-2" onClick={() => fileInputRef.current?.click()}><ImageIcon className="w-4 h-4" />Upload</button>
                  </div>
                </div>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="space-y-5">
                ...
                <div className="group animate-slide-in-up">
                  ...
                  <select id="idType" name="idType" value={formData.idType} onChange={handleChange} className="block w-full pl-4 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-300 hover:border-gray-300">
            ...
            <div className="flex justify-between mt-8">
              ...
              {step < 4 && (
                <button type="button" className="px-6 py-3 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 ml-auto" onClick={() => { if (validateStep()) setStep(step + 1); else toast.error('Please fill all required fields.') }} disabled={isLoading}>Next</button>
              )}
              {step === 4 && (
